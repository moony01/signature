...
<div style="display:none;" >
    ...
    <!--<div style="position:relative; height:0px;padding-bottom: 56%; ">
    	<iframe src="https://www.youtube.com/embed/KSsA6kUQKpQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="position: absolute;top: 0;left: 0;width: 100%;height: 100%;"></iframe>
		</div>-->
		<div style="position:relative; height:0px;padding-bottom: 56%; ">
...
<div class="sign-write-box">
    ...
    <div class="sns-sc">
		...
		<!--<a onclick="sendLink()" id="kakao-link-btn" class="s-kakao" target="_blank">카카오톡</a>-->
        <!-- <a href="javaScript:share_sns(2,'https://www.okatom.org/','동학농민혁명 125주년 및 3.1운동 100주년
    일본제품 불매 및 친일청산 범국민 서명운동')" class="s-twitter" target="_blank">트위터</a> -->
    ...
    <div class="sign-form">
        <div class="sign-text-box">
            <div class="sign-text">
                ...
                <a href="./privacy.html" class="privacy"  target="_blank">개인정보 보호정책</a></em>
            </div>
			
        </div>
		<a href="./1by1.php" target="_self" style="background: #195ea5; font-size: 15px; margin-top: 2em; padding: 3px 15px; display: inline-block; border-radius: 4px; color: #fff;">온라인서명하기</a>
    </div>
...
<div id="footer">
<div class="copyright">
    <a href="#" onClick="event.preventDefault();document.getElementById('logout-form').submit();" class="onsite-logout">일본제대로알기운동본부(본부장 황호진)</a><br />
    (전화: 063-276-4650, 팩스: 0504-489-3535, 이메일: dlgusco04@nate.com)
    
    <form id="logout-form" action="https://okatom.org/logout" method="POST" style="display: none;">
        <input type="hidden" name="layoutCode" value="">
        <input type="hidden" name="_token" value="lf5kUGPGFPeplLV3smXxhFr7Fcg5SvUzenxr87Oc">
    </form>
</div>
</div>
